...
const STYLE_POSTS = [
  { user: "anaya_thrifts",  avatar: "🌸", caption: "Paired this vintage knit with wide-leg denim for a cozy cottagecore morning ☕", image: "https://cdn.mos.cms.futurecdn.net/bPMd9UchddqtiU3hCKBtL4.jpeg", tags: ["#cottagecore", "#thriftedfit"], productTitles: ["Cream Cable Knit Sweater", "Wide-Leg Blue Denim"], likes: 1243 },
  { user: "retro_rani",     avatar: "🎀", caption: "Red bomber season is officially open. Going full Y2K maximalist this week", image: "https://y2kdream.com/cdn/shop/files/Y2K-Leather-Bomber-Jacket-Red.webp?v=1723618959&width=2048", tags: ["#y2k", "#streetstyle"], productTitles: ["Red Cropped Bomber"], likes: 2891 },
  { user: "vintage_vault",  avatar: "🍂", caption: "Old money energy with a thrifted Breton stripe. Timeless, tenderly loved 🤍", image: "https://www.northsails.com/cdn/shop/files/699179_0105_msfront1.jpg?v=1752143280&width=900", tags: ["#oldmoney", "#quietluxury"], productTitles: [], likes: 1567 },
  { user: "grunge_gallery", avatar: "⚡", caption: "Oversized flannel + chunky chain = the uniform. Thrifting > fast fashion always", image: "https://assets.myntassets.com/w_412,q_50,,dpr_3,fl_progressive,f_webp/assets/images/2025/DECEMBER/16/tDidXymW_f3214d3de2be45fca957d4ad4e932690.jpg", tags: ["#grunge", "#sustainable"], productTitles: ["Brown Plaid Flannel Shirt", "Chunky Gold Chain Necklace"], likes: 987 },
  { user: "noir_closet",    avatar: "🖤", caption: "Platform boots era. Pre-loved, post-punk mood ✦", image: "https://fashionmagazine.mblycdn.com/fm/resized/2023/10/1600x1200/Platform-boots.png", tags: ["#grunge", "#vintage"], productTitles: ["Black Combat Boots"], likes: 2134 },
  { user: "soiree_seconds", avatar: "✨", caption: "Slip dress season. Found this gem for ₹899 and I'm obsessed", image: "https://img105.savana.com/goods-pic/ffcf6e139bfd485abafc7e3df3d31532_w540_h720_q85.webp", tags: ["#y2k", "#luxe"], productTitles: ["Black Satin Slip Dress"], likes: 1789 },
];
